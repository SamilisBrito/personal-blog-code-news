  ...
  posts.forEach((post) => {
    ...
    <div class="content">
      <p class="mb-3">
        ...
        <span class="text-slate-500">${createdAt.getDate()}, ${createdAt.toLocaleString(
      "pt-br",
      { month: "long" }
    )} de ${createdAt.getFullYear()}</span>
...
function navigateToFormAddPost(id = "") {
